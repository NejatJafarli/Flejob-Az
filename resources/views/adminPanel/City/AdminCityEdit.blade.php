        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('UpdateCity', app()->getLocale()) }}" method="POST">
                        @csrf
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text"
                                                name="CityName[{{ $language->LanguageCode }}]" id="example-text-input"
                                                required value="{{ $cities[$loop->index]['CityName'] }}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            @endforeach
                            <input type="hidden" name="CityId" value="{{ $cities[0]['city_id'] }}">
                        </div>
                </div>
