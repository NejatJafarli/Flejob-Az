    ...
    <div class="terms-section pt-100 pb-100">
        <div class="container">
            <div class="terms-text">
                ...
                <h3>2. Limitations</h3>
                <p>In no event shall Fixa or its suppliers be liable for any damages (including, without limitation,
                    damages for loss of data or profit, or due to business interruption) arising out of the use or
                    inability to use the materials on Fixa's website, even if Fixa or a Fixa authorized representative
                ...
                <p>The materials appearing on Fixa's website could include technical, typographical, or photographic
                    errors. Fixa does not warrant that any of the materials on its website are accurate, complete or
                    current. Fixa may make changes to the materials contained on its website at any time without notice.
                    However Fixa does not make any commitment to update the materials.</p>

                <h3>4. Links</h3>
                <p>Fixa has not reviewed all of the sites linked to its website and is not responsible for the contents
                    of any such linked site. The inclusion of any link does not imply endorsement by Fixa of the site.
                    Use of any such linked website is at the user's own risk.</p>

                <h3>5. Modifications</h3>
                <p>Fixa may revise these terms of service for its website at any time without notice. By using this
