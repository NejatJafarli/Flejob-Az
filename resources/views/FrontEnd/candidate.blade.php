                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav m-auto">
                            <li class="nav-item">
                                <a {{ route('Hom', app()->getLocale()) }} class="nav-link">Home</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="candidate.html" class="nav-link active">Candidates</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="candidate-details.html" class="nav-link active">Candidates Details</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
