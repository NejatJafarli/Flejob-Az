                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                        <ul class="navbar-nav m-auto">
                            <li class="nav-item">
                                <a href="{{ route('Hom', app()->getLocale()) }}" class="nav-link dropdown">Home</a>
                            </li>
                            <li class="nav-item">
                        ...
                        @if (session()->has('user'))
                            <div class="others-option d-flex align-items-center">
                                <div class="option-item">
                                    ...
                                    <a href="{{ route('Hom', app()->getLocale()) }}" class="default-btn">
                                        {{ session()->get('user')->name }}
                                    </a>
                                </div>
                                <div class="option-item">
                                    <i class='bx bx-log-out'></i>
                                    <a href="{{ route('Logout', app()->getLocale()) }}" class="default-btn">
                                        Logout
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-8 offset-md-2 offset-lg-3">
                    ...
                    <form id="signin" class="signin-form" method="POST"
                        ...
                        <div class="signin-btn text-center">
                            <button onclick="SignIn({{ route('Signin', app()->getLocale()) }})">Sign In</button>
                        </div>
